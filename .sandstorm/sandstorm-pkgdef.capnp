...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "4uda6a9yfxk4v3x2mpxjdn2md9y54tj104091480qjr8h758u4dh",
  ...
  manifest = (
    ...
    appMarketingVersion = (defaultText = "1.9.7-1"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "3000", "--", "/bin/bash", "/opt/app/.sandstorm/launcher.sh"],
  environ = [
